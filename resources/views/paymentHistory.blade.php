        ...
        <div class="col-xs-6 col-sm-6 mx-auto col-lg-6">
            <div class="card">
                ...
                <div class="card-body card-block">
                    <form action="/pembayaran-cari" method="POST">
                        @csrf
                                ...
                                <table class="table " id="jadwal">
                                    <thead>
                                        <tr class="text-center">
                                            ...
                                            <th class="avatar">Jumlah Angsuran</th>
                                            <th>Total</th>
                                    ...
                                    <tbody>
                                        @foreach($pembayaran as $bayar)                                            
                                            <tr class="text-center baris">
                                                <td class="id"> {{$bayar->id_siswa}} </td>
                                                <td class="serial tanggal">{{$bayar->nama_lengkap}}</td>
                                                @if(!empty($bayar->jumlahBayar)&& !empty($bayar->jumlahBayar))
                                                    <td class="jam"> <span class="name">{{$bayar->jumlahBayar}}</span> </td>
                                                    <td class="mapel"> {{$bayar->nominal}} </td>
                                                @else
                                                    <td class="jam"> <span class="name">0</span> </td>
                                                    <td class="mapel"> 0 </td>
                                                @endif
                                                <td> 
